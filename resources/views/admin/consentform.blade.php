...
@endif
         ...
         <section class="content-header"><h2>Consent Form</h2></section>
    ...
    <div class="wrap-contact100">
      <div class="contact100-form-title" style="background-image: url(/images/physiofit-logo.jpg);"> <!-- style="background-image: url(/images/physiofit-logo.jpg);" -->
        <span class="contact100-form-title-1">
           <img src="{{ asset('/images/physiofit-logo.jpg')}}" width="100" height="50"> 
        </span>
      ...
      <div class="wrap-input100 validate-input" data-validate="Name is required">
        ...
        <div>
          <p>In consideration of my desire to engage in an exercise programme at the PHYSIOFIT.I understand and agree to following :</p>
          <span class="focus-input100"></span>
        </div><br/>
        ...
        <div>
          <ol>
            ...
            <li>Befre i Engage in any activity i have informed all my medical history to the team member of PHYSIOFIT and have complated health history form as well as an evaluation with physical therapist to determine my risk of participating exercise.i m sumbmitting all helth report to PHYSIOFIT.</li><br/>
    ...
    <div class="col-sm-4">TEAM PHYSIOFIT</div>
  </div>
