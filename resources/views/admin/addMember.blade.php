...
<!--         </article> --> 
        <article class="content-entry open" >
            ...
            <div class="accordion-content" style="display:block;"><br/>
               <div class="well well-lg">
            ...
            <div class="form-group">
              <label>Email</label>
                ...
                <input type="email" id="email" name="email" class="form-control"placeholder="Email Id"  class="span11" />
              </div>
                <div class="form-group">
             <label>Cell Phone Number</label>
             
                <input type="text" name="CellPhoneNumber" id="MobileNo" minlength="10" maxlength="10"
        class="form-control number" placeholder="Cell Phone Number" required=""  class="span11" /><span id="error_usermobile"></span>
               </div>
               <div class="form-group">
             <label>Preferred Timing</label><br>
        ...
        <article class="content-entry">
            ...
            <textarea rows="2" cols="20" name="Address" wrap="soft" class="form-control"  placeholder="Address" class="span11"></textarea>
             ...
             <label>Home Phone Number</label>
                ...
                <input type="text" name="HomePhoneNumber" class="form-control number" id="HomePhoneNumber"placeholder="Home Phone Number"  minlength="10" maxlength="10" class="span11" />
            ...
            <div class="form-group">
             <label>Office Phone Number</label>
                ...
                <input type="text" name="OfficePhoneNumber" class="form-control number" id="OfficePhoneNumber" placeholder="Office Phone Number"  minlength="10" maxlength="10" class="span11" />
                <span class="errmsg"></span>
               </div>
        ...
        <article class="content-entry" >
            ...
            <textarea rows="2" cols="20" name="emergancyaddress" wrap="soft" class="form-control"  placeholder="Emergancy Address" class="span11"></textarea>
             ...
             <label>Emergancy Contact Number</label>
                ...
                <input type="text" name="EmergancyPhoneNumber" id="EmergancyPhoneNumber" class="form-control number" placeholder="EmergancyPhoneNumber"  minlength="10" maxlength="10" class="span11" />&nbsp;<span class="errmsg"></span>
               </div>
        ...
        <article class="content-entry">
            ...
            <div class="accordion-content">
                ...
                <input type="text" name="bloodgroup" class="form-control"  class="span10" />
               </div>
                      <div class="form-group">
            ...
            <div class="accordion-content"><br/>
             ...
             <label>Birthdate</label>
                ...
                <input placeholder="Birthdate" type="date" class="form-control" max="<?php echo date('Y-m-d');?>" name="birthday" class="span11">
            
            </div>
              <div class="form-group">
             <label>Anniversary</label>
             
                <input placeholder="Anniversary"  max="<?php echo date('Y-m-d');?>" type="date" class="form-control" name="anniversary" class="span11">
...
<div class="field" align="left">
  ...
  <i id="file"></i>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-offset-4"><button type="submit" class="btn bg-orange margin" onClick="return ValidateForm(this.form)">
         Save</button>
         <a href="{{ url('members') }}"class="btn bg-red margin">Cancel</a></div>
</div>          </form>
<script type="text/javascript">
