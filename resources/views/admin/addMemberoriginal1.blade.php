...
<section id="content">
  <form action="{{ url('addMember') }}" method="post" enctype="multipart/form-data" enctype="multipart/formdata">  {{ csrf_field() }}
...
<!-- <a href="{{url('verify')}}" id="verify">verify</a> -->
           ...
           <article class="content-entry">
            ...
            <div class="accordion-content"><br/>
                ...
                <div class="content-fit-box">
                 ...
                 <!--     <td> <label for="1" class="btn btn-success">Body Building <input type="checkbox" class="badgebox"><span class="badge">&check;</span></label></td> -->
              ...
              @endforeach
               ...
               <!--  <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                  <input type="text"  name="firstname" id="firstname" class="form-control"placeholder="Lastname"  class="span11" required="" />
                  </div>
                </div><br/> -->
              <!--   <div class="row" >
                  <div class="col-md-6">
                  <label>Your Daily Routing Activity ?</label>
                  </div>
                  <div class="col-md-6">
...
<!-- 
 ...
 -->
          ...
          <article class="content-entry">
            <h4 class="article-title"><i></i>Excercise Program</h4>
            <div class="accordion-content"><br/>
              <div class="well well-lg">
